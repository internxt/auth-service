...
*/
Server.post('/accounts/register', async (req, res) => {
...
Server.post('/accounts/login', (req, res) => {
...
/**
   ...
   *         description: Wrong username or password
*/
Server.post('/accounts/access', (req, res) => {
...
*/
Server.get('/accounts/tfa', passportAuth, (req, res) => {
...
Server.put('/accounts/tfa', passportAuth, (req, res) => {
...
Server.delete('/accounts/tfa', passportAuth, (req, res) => {
    const user = req.user.email;
...
Server.put('/accounts/mnemonic', passportAuth, (req, res) => {
    const {
      body: { email, mnemonic }
    } = req;
...
Server.patch('/accounts/password', passportAuth, (req, res) => {
    const user = req.user.email;
